...
$sql = "UPDATE tblusers SET FullName=:name, ContactNo=:mobileno, dob=:dob, Address=:adress, City=:city, Country=:country, AadhaarNumber=:aadhar WHERE EmailId=:email";
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <input class="form-control white_bg" name="aadhar" value="<?php echo htmlentities($result->AadhaarNumber);?>" id="aadhar" type="text" required>
            </div>
